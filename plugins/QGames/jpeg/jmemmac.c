 ...
 * NB: we include keywords in the routine declarations simply for
 * consistency with the rest of the IJG code; should expand to empty
...
static void read_backing_store (j_common_ptr cinfo, backing_store_ptr info,
		    void * buffer_address,
...
static void write_backing_store (j_common_ptr cinfo, backing_store_ptr info,
		     void * buffer_address,
		     long file_offset, long byte_count)
{
  long bytes = byte_count;
