...
struct jvirt_sarray_control {
  ...
  jp_bool pre_zero;		/* pre-zero mode requested? */
  jp_bool dirty;		/* do current buffer contents need written? */
  jp_bool b_s_open;		/* is backing-store data valid? */
...
static jvirt_sarray_ptr request_virt_sarray (j_common_ptr cinfo, int pool_id, jp_bool pre_zero,
		     JDIMENSION samplesperrow, JDIMENSION numrows,
...
static jvirt_barray_ptr request_virt_barray (j_common_ptr cinfo, int pool_id, jp_bool pre_zero,
		     JDIMENSION blocksperrow, JDIMENSION numrows,
		     JDIMENSION maxaccess)
...
static void do_sarray_io (j_common_ptr cinfo, jvirt_sarray_ptr ptr, jp_bool writing)
...
static void do_barray_io (j_common_ptr cinfo, jvirt_barray_ptr ptr, jp_bool writing)
